...
export default function StoryPage() {
  return (
    <PageWrapper>
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-20 space-y-16 md:space-y-32 overflow-hidden">
        {/* Hero Section */}
        <section className="text-center space-y-6 md:space-y-8 max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-8xl font-serif text-brown leading-tight">
            Baked with <span className=" font-normal text-caramel">Tradition</span>, <br className="hidden md:block" />
            Served with Love
          </h1>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="relative group">
            ...
            <div className="aspect-[4/5] rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-warm border-4 md:border-8 border-cream-highlight relative">
              <Image
        ...
        <section className="text-center max-w-3xl mx-auto py-8 md:py-10">
          <p className="text-2xl md:text-4xl font-serif text-brown  leading-tight">
