          ...
          >
              ...
              <Card className="rounded-3xl border-none shadow-soft bg-white">
                <CardContent className="p-6 md:p-8">
                  ...
                  <form id="profile-form" onSubmit={handleUpdateProfile} className="space-y-4 md:space-y-5">
                    ...
                    <Button
                      type="submit"
                      className={`hidden sm:flex w-full h-12 rounded-xl font-bold transition-all ${isProfileChanged && !profileLoading ? 'bg-sage text-white' : 'bg-gray-100 text-gray-400'
                        }`}
                  ...
                  <Card className="rounded-3xl border-none shadow-soft bg-white">
                    <CardContent className="p-6 md:p-8">
                      ...
                      <form onSubmit={handleUpdatePassword} className="space-y-4 md:space-y-5">
                        ...
                        <Button
                          type="submit"
                          className={`w-full h-12 rounded-xl font-bold transition-all ${isPasswordReady && !passwordLoading ? 'bg-caramel text-white' : 'bg-gray-100 text-gray-400'
                            }`}
            ...
            <div className="fixed bottom-0 left-0 right-0 p-4 bg-white/95 backdrop-blur-md border-t border-brown/5 shadow-[0_-10px_40px_-10px_rgba(0,0,0,0.1)] z-30 sm:hidden">
              <Button
                type="submit"
                form="profile-form"
                className={`w-full h-14 rounded-2xl font-bold text-sm transition-all ${isProfileChanged && !profileLoading
              ...
              <div className="p-6 md:p-10">
                {selectedOrder.status === 'Cancelled' ? (
                  <div className="text-center py-6 md:py-10 space-y-4">
                    ...
                    <p className="text-muted text-sm ">This order is no longer being processed.</p>
                  </div>
                ) : (
                        ...
                        return (
                          <div key={stage} className="flex flex-row lg:flex-col items-start lg:items-center gap-5 lg:gap-3 relative lg:flex-1">
                            ...
                            <div className="flex-1 pb-6 lg:pb-0 min-w-0 pt-2 lg:pt-0 lg:text-center w-full">
                              ...
                              {isCurrent && <p className="text-[9px] text-muted  mt-0.5">In Progress...</p>}
                            </div>
