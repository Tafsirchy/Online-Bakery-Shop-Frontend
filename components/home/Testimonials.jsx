...
export default function Testimonials() {
  return (
    <section className="relative py-12 md:py-32 px-6 overflow-hidden bg-[#fffdfa]">
            ...
            >
              ...
              <div className="space-y-6 relative z-10">
                ...
                <div className="relative">
                  <p className="text-base md:text-lg font-serif italic text-brown/90 leading-relaxed line-clamp-4 md:line-clamp-none">
                ...
                <div className="pt-6 flex items-center gap-4 border-t border-brown/5">
                  <div className="relative">
                    <div className="w-12 h-12 md:w-14 md:h-14 rounded-full border-4 border-white shadow-md overflow-hidden ring-1 ring-brown/5">
          ...
          <div className="inline-flex flex-col items-center gap-3 md:gap-4 px-6 md:px-8 py-4 bg-white rounded-full shadow-soft border border-brown/5">
            ...
            <div className="flex -space-x-3 overflow-hidden">
              {[1, 2, 3, 4, 5].map((i) => (
                <img
                  key={i}
                  className="inline-block h-7 w-7 md:h-8 md:w-8 rounded-full ring-2 ring-white"
