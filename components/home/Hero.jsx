...
export default function Hero() {
  return (
    <section className="relative min-h-[90vh] lg:min-h-0 bg-cream overflow-hidden py-8 md:py-20 flex flex-col justify-center">
      {/* Background decor */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 relative w-full">
            <motion.div
              ...
              className="bg-white/40 lg:bg-transparent backdrop-blur-xl lg:backdrop-blur-none p-0 lg:p-0 rounded-[2.5rem] lg:rounded-none border border-white/50 lg:border-none shadow-xl shadow-brown/5 lg:shadow-none space-y-8 flex flex-col items-start text-left w-full"
            >
              <div className="space-y-4 md:space-y-6">
                ...
                <h1 className="text-[32px] md:text-5xl lg:text-7xl font-serif font-medium text-brown leading-[1.1] tracking-tight">
                  Baking the World
                  <span className=" font-normal text-caramel block mt-1 lg:mt-0">a Better Place</span>
                </h1>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 pt-6 border-t border-brown/5 w-full">
                <div className="flex -space-x-2">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="w-8 h-8 rounded-full border-2 border-white bg-caramel/20 overflow-hidden shadow-sm relative">
                      <Image
